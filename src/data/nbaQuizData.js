...
const nbaQuizData = [
  {
    ...
    correctAnswer: "Vilts Čemberleins",
  },
  {
    question: "Kura komanda uzvarēja NBA čempionātā 2020.-2021. gadā?",
    options: [
      "Losandželosas Leikeri",
      "Maiami Hīts",
      "Milvoki Baks",
      "Goldensteitas Worriors",
    ],
    correctAnswer: "Milvoki Baks",
  },
  {
    question: "Kurš NBA ir pazīstams kā 'Grieķu frīks'?",
    options: [
      "Džianiss Antetokumpo",
      "Luka Dončičs",
      "Džeimss Hardens",
      "Kevins Durants",
    ],
    correctAnswer: "Džianiss Antetokumpo",
  },
  {
    question:
      "Kurš spēlētājs ir plaši atzīts par vislieliskāko trīspunktu metēju NBA vēsturē?",
    options: [
      "Rejs Allens",
      "Stīvens Karijs",
      "Redžijs Millers",
    ...
    correctAnswer: "Stīvens Karijs",
  },
  {
    question:
      "Kurā gadā Mihails Džordans pirmo reizi izbeidza profesionālo basketbolu?",
    options: ["1993", "1996", "1998", "2003"],
    correctAnswer: "1996",
  },
  {
    question:
      "Kura NBA komanda izvēlējās Dīrku Novicki 1998. gadā, pirms viņu aizmainījam uz Dalasas Maverikiem?",
    options: [
      "Losandželosas Klipers",
      "Milvoki Baks",
      "Bostona Seltiks",
      "Dalasas Maveriki",
    ],
  ...
  },
  {
    ...
    options: [
      "LeBrons Džeims",
      "Karems Abduls-Džabars",
      "Karls Malons",
      "Kobijs Braiants",
    ],
    correctAnswer: "LeBrons Džeims",
  },
  {
    ...
    correctAnswer: "Karems Abduls-Džabars",
  },
  {
    question:
      "Kurā komandā LeBrons Džeimss spēlēja uzvarot NBA čempionātā 2016. gadā?",
    options: [
      "Maiami Hīts",
      "Klīvlendas Kavalīrsi",
      "Losandželosas Leikeri",
      "Goldensteitas Worriors",
    ],
    correctAnswer: "Klīvlendas Kavalīrsi",
  },
  {
  ...
  {
    question:
      "Kurš NBA spēlētājs ir ieguvis rekordlielu trijnieku (triple-double) skaitu vienā sezonā?",
    options: [
      "LeBron James",
      "Russell Westbrook",
      "Magic Johnson",
  ...
  {
    question:
      "Kurš NBA spēlētājs ir ieguvis visvairāk punktu karjerā, spēlējot tikai vienā komandā?",
    options: ["Kobe Bryant", "Tim Duncan", "Dirk Nowitzki", "John Stockton"],
    correctAnswer: "Dirk Nowitzki",
  },
  {
    question:
      "Cik reizes ir bijis All-Star spēlēs piedalījies NBA spēlētājs Dirk Nowitzki?",
    options: ["12", "14", "16", "18"],
    correctAnswer: "14",
  },
  {
  ...
  {
    question:
      "Kurš NBA spēlētājs ir ieguvis visvairāk rezultīvu piespēļu karjerā?",
  ...
  },
  {
    ...
    correctAnswer: "Goldensteitas Warriors",
  },
  {
  ...
  {
    question:
      "Kurš NBA spēlētājs ir pazīstams kā 'Splash Brother' kopā ar Stephen Curry?",
    options: [
      "Klay Thompson",
      "Damian Lillard",
      "Devin Booker",
  ...
  {
    question:
      "Kurš NBA spēlētājs ir veidojis savu hiphopa grupu saucamu par 'D.O.L.L.A.'?",
    options: [
      "Damian Lillard",
      "Russell Westbrook",
      "Chris Paul",
  ...
  {
    question:
      "Kurš NBA spēlētājs ir uzvarējis visvairāk 'Defensive Player of the Year' balvās vēsturē?",
    options: ["Dwight Howard", "Ben Wallace", "Kawhi Leonard", "Rudy Gobert"],
    correctAnswer: "Dwight Howard",
  },
  {
    question:
      "Cik reizes Michael Jordan ir izcēlies ar sezonas labākā rezultāta vidējo punktu skaitu regulārajā sezonā?",
    options: ["5", "7", "9", "10"],
    correctAnswer: "10",
  },
  {
    question:
      "Kura NBA komanda ir uzvarējusi visvairāk uzvaru regulārās sezonas vēsturē?",
    options: [
      "Los Angeles Lakers",
      "Chicago Bulls",
      "Boston Celtics",
  ...
  {
    question:
      "Cik reizes Kobe Bryant ir bijis NBA labākais punktu guvējs (scoring champion) savā karjerā?",
    options: ["3", "5", "7", "2"],
    correctAnswer: "2",
  },
  {
    question:
      "Cik reizes Shaquille O'Neal ir ieguvis 'quadruple-double' savā karjerā?",
    options: ["1", "2", "0", "3"],
    correctAnswer: "0",
  },
  {
    question:
      "Cik reizes Magic Johnson ir ieguvis vismaz 20 punktus un 20 rezultatīvas piespēles vienā spēlē?",
    options: ["13", "11", "9", "8"],
    correctAnswer: "13",
  },
  {
    question:
      "Cik reizes John Stockton ir ieguvis vismaz 20 punktus un 20 rezultatīvas piespēles vienā spēlē?",
    options: ["13", "11", "9", "8"],
    correctAnswer: "9",
  },
  {
    question:
      "Cik reizes Russell Westbrook ir ieguvis vismaz 20 punktus un 20 rezultatīvas piespēles vienā spēlē?",
    options: ["7", "11", "9", "8"],
    correctAnswer: "7",
  },
  {
    question:
      "Cik reizes Kobe Bryant ir ieguvis vismaz 50 punktus vienā spēlē?",
    options: ["12", "16", "20", "24"],
    correctAnswer: "12",
  },
  {
    question:
      "Cik reizes Scottie Pippen ir ieguvis NBA finālu MVP savā karjerā?",
    options: ["0", "1", "2", "3"],
    correctAnswer: "0",
  },
  {
    question:
      "Cik reizes Hakeem Olajuwon ir bijis NBA labākais bloku (blocks) līderis regulārajā sezonā?",
    options: ["2", "4", "6", "8"],
    correctAnswer: "2",
  },
  {
    question:
      "Cik reizes Allen Iverson ir ieguvis vismaz 50 punktus (playoff) spēlē?",
    options: ["1", "2", "3", "4"],
    correctAnswer: "2",
  },
  {
    question:
      "Cik reizes Steve Nash ir ieguvis NBA regulārās sezonas MVP balvu?",
    options: ["1", "2", "3", "4"],
    correctAnswer: "2",
  },
  {
    question:
      "Kurš NBA spēlētājs ir bijis pirmais, kurš ieguva 'quadruple-double' regulārajā sezonā?",
    options: [
      "Hakeem Olajuwon",
      "David Robinson",
      "Alvin Robertson",
  ...
  {
    question:
      "Kura NBA komanda ir bijusi pazīstama kā 'Bad Boys' un izcēlusies ar fizisku spēli 1980. gados?",
    options: [
      "Los Angeles Lakers",
      "Detroit Pistons",
      "Boston Celtics",
  ...
  {
    question:
      "Cik reizes Kobe Bryant ir ieguvis vismaz 60 punktus vienā spēlē?",
    options: ["1", "2", "3", "4"],
    correctAnswer: "1",
  },
  {
    question:
      "Cik reizes LeBron James ir ieguvis triple-double NBA All-Star spēlē?",
    options: ["1", "2", "3", "4"],
    correctAnswer: "1",
  },
  {
  ...
  {
    question:
      "Kura NBA komanda ir pazīstama ar savu 'Banana Boat' draugu grupu?",
    options: [
      "Miami Heat",
      "Cleveland Cavaliers",
      "Los Angeles Lakers",
  ...
  {
    question:
      "Kurš NBA spēlētājs ir rakstījis grāmatu ar nosaukumu 'The Sixth Man'?",
  ...
  },
  {
    ...
    correctAnswer: "Utah Jazz",
  },
  {
    question:
      "Kurš NBA spēlētājs ir uzskatīts par visu laiku labāko aizsargu un saucams par 'The Glove'?",
  ...
  {
    question:
      "Kurš spēlētājs tika atzīts par Vērtīgāko spēlētāju sezonā 2016-2017?",
    options: [
      "Russell Westbrook",
      "Stephen Curry",
      "LeBron James",
  ...
  {
    question: "Kurš spēlētājs saņēma NBA Finals MVP balvu sezonā 2014-2015?",
    options: ["Stephen Curry", "LeBron James", "Kawhi Leonard", "James Harden"],
  ...
  },
  {
    ...
    correctAnswer: "LaMelo Ball",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2019-2020?",
    options: [
      "Ja Morant",
      "Zion Williamson",
      "Kendrick Nunn",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2017-2018?",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2014-2015?",
    options: [
      "Andrew Wiggins",
      "Nikola Mirotić",
      "Elfrid Payton",
  ...
  },
  {
    ...
    correctAnswer: "Michael Carter-Williams",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2012-2013?",
    options: [
      "Damian Lillard",
      "Anthony Davis",
      "Bradley Beal",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2009-2010?",
    options: [
      "Tyreke Evans",
      "Stephen Curry",
      "Brandon Jennings",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2007-2008?",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2004-2005?",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 2002-2003?",
    options: ["Amar'e Stoudemire", "Yao Ming", "Caron Butler", "Drew Gooden"],
    correctAnswer: "Amar'e Stoudemire",
  },
  {
  ...
  },
  {
    ...
    correctAnswer: "Mike Miller",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 1999-2000?",
    options: ["Elton Brand", "Steve Francis", "Lamar Odom", "Baron Davis"],
    correctAnswer: "Elton Brand",
  },
  {
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 1997-1998?",
    options: [
      "Tim Duncan",
      "Keith Van Horn",
      "Chauncey Billups",
  ...
  },
  {
    ...
    correctAnswer: "Grant Hill",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 1994-1995?",
  ...
  },
  {
    ...
    correctAnswer: "Chris Webber",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Rookie of the Year balvu sezonā 1992-1993?",
    options: [
      "Shaquille O'Neal",
      "Alonzo Mourning",
      "LaPhonso Ellis",
  ...
  },
  {
    ...
    correctAnswer: "Jordan Clarkson",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2019-2020?",
    options: [
      "Lou Williams",
      "Montrezl Harrell",
      "Dennis Schröder",
    ...
    correctAnswer: "Montrezl Harrell",
  },
  {
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2017-2018?",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2014-2015?",
    options: [
      "Lou Williams",
      "Isaiah Thomas",
      "Andre Iguodala",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2012-2013?",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2010-2011?",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2008-2009?",
    options: ["Jason Terry", "Manu Ginóbili", "Travis Outlaw", "J.R. Smith"],
    correctAnswer: "Jason Terry",
  },
  {
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2006-2007?",
    options: [
      "Leandro Barbosa",
      "Manu Ginóbili",
      "Jerry Stackhouse",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2004-2005?",
    options: [
      "Ben Gordon",
      "Cuttino Mobley",
      "Jason Terry",
  ...
  },
  {
    ...
    correctAnswer: "Antawn Jamison",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Sixth Man of the Year balvu sezonā 2002-2003?",
    options: [
      "Bobby Jackson",
      "Corliss Williamson",
      "Jalen Rose",
    ...
    correctAnswer: "Corliss Williamson",
  },
  {
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2019-2020?",
    options: [
      "Brandon Ingram",
      "Bam Adebayo",
      "Luka Dončić",
  ...
  },
  {
    ...
    correctAnswer: "Pascal Siakam",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2017-2018?",
    options: [
      "Victor Oladipo",
      "Clint Capela",
      "Spencer Dinwiddie",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2015-2016?",
    options: [
      "C.J. McCollum",
      "Giannis Antetokounmpo",
      "Kemba Walker",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2013-2014?",
    options: [
      "Goran Dragić",
      "Anthony Davis",
      "DeAndre Jordan",
  ...
  },
  {
    ...
    correctAnswer: "Paul George",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2011-2012?",
    options: [
      "Ryan Anderson",
      "Ersan İlyasova",
      "Nikola Peković",
  ...
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2009-2010?",
    options: ["Aaron Brooks", "Kevin Durant", "Joakim Noah", "Derrick Rose"],
    correctAnswer: "Aaron Brooks",
  },
  {
    ...
    correctAnswer: "Danny Granger",
  },
  {
    question:
      "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2007-2008?",
    options: ["Hedo Türkoğlu", "Andrew Bynum", "Al Jefferson", "Monta Ellis"],
    correctAnswer: "Hedo Türkoğlu",
  },
  {
  ...
  },
  {
    ...
    correctAnswer: "Tom Thibodeau",
  },
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2019-2020?",
  ...
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2017-2018?",
    options: ["Dwane Casey", "Quin Snyder", "Brad Stevens", "Mike D'Antoni"],
    correctAnswer: "Dwane Casey",
  },
  {
    ...
    correctAnswer: "Mike D'Antoni",
  },
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2015-2016?",
  ...
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2013-2014?",
    options: [
      "Gregg Popovich",
      "Tom Thibodeau",
      "Jeff Hornacek",
  ...
  },
  {
    ...
    correctAnswer: "George Karl",
  },
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2011-2012?",
    options: [
      "Gregg Popovich",
      "Tom Thibodeau",
      "Lionel Hollins",
  ...
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2009-2010?",
    options: ["Scott Brooks", "Lionel Hollins", "Nate McMillan", "George Karl"],
    correctAnswer: "Scott Brooks",
  },
  {
    ...
    correctAnswer: "Mike Brown",
  },
  {
    question:
      "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2007-2008?",
    options: ["Byron Scott", "Sam Mitchell", "Doc Rivers", "Stan Van Gundy"],
    correctAnswer: "Byron Scott",
  },
  {
  ...
  {
    question:
      "Kurš spēlētājs ir NBA visu laiku top 10 pēc rezultatīvajām piespēlēm?",
  ...
  },
  {
    question:
      "Kurš spēlētājs ir NBA visu laiku top 10 pēc rezultatīvajām piespēlēm?",
    options: ["Mark Jackson", "Muggsy Bogues", "Tim Hardaway", "James Harden"],
    correctAnswer: "Mark Jackson",
  },
  {
    question:
      "Kurš spēlētājs ir NBA visu laiku top 10 pēc rezultatīvajām piespēlēm?",
    options: ["Magic Johnson", "Lenny Wilkens", "Tim Hardaway", "James Harden"],
    correctAnswer: "Magic Johnson",
  },
  {
    question:
      "Kurš spēlētājs ir NBA visu laiku top 10 pēc rezultatīvajām piespēlēm?",
    options: ["Steve Nash", "Lenny Wilkens", "	Muggsy Bogues", "James Harden"],
    correctAnswer: "Steve Nash",
  },
  {
    question:
      "Kurš spēlētājs ir NBA visu laiku top 10 pēc rezultatīvajām piespēlēm?",
    options: ["Lebron James", "Muggsy Bogues", "Tim Hardaway", "James Harden"],
    correctAnswer: "Lebron James",
  },
  {
  ...
  },
  {
    ...
    correctAnswer: "Markelle Fultz",
  },
  {
    question:
      "Kurš spēlētājs ir visu laiku labākais steal spēlētājs NBA vēsturē?",
  ...
  {
    question:
      "Kurš no šiem spēlētājiem ir piektais visu laiku steals sarakstā?",
  ...
  },
  {
    ...
    correctAnswer: "Maurice Cheeks",
  },
  {
    question:
      "Kurš no šiem spēlētājiem ir septītais visu laiku steals sarakstā?",
    options: [
      "Scottie Pippen",
      "Maurice Cheeks",
      "John Stockton",
  ...
  {
    question:
      "Kurš no šiem spēlētājiem ir devītais visu laiku steals sarakstā?",
    options: [
      "Clyde Drexler",
      "LeBron James",
      "Scottie Pippen",
  ...
  {
    question: "No kuras valsts ir Jamal Murray?",
    options: ["Kanāda", "Austrālija", "Jaunzēlande", "Singapūra"],
    correctAnswer: "Kanāda",
  },
  {
  ...
  },
  {
    ...
    correctAnswer: "Bosnija un Hercegovina",
  },
  {
  ...
  {
    question:
      "Kurā gadā Kobe Bryant ieguva savu pirmo NBA čempionu gredzenu ar Los Angeles Lakers?",
    options: ["1999", "2002", "2005", "2008"],
    correctAnswer: "2000",
  },
  {
    question:
      "Kurā gadā Michael Jordan ieguva savu pēdējo NBA čempionu gredzenu ar Chicago Bulls?",
    options: ["1993", "1996", "1998", "2001"],
    correctAnswer: "1998",
  },
  {
    question:
      "Kurā gadā Shaquille O'Neal ieguva savu pirmo NBA čempionu gredzenu ar Los Angeles Lakers?",
    options: ["1995", "1998", "2000", "2003"],
    correctAnswer: "2000",
  },
  {
    question:
      "Kurā gadā Stephen Curry ieguva savu pirmo NBA čempionu gredzenu ar Golden State Warriors?",
    options: ["2013", "2015", "2017", "2019"],
    correctAnswer: "2015",
  },
  {
    question: "Kurā gadā Kevin Durant ieguva savu pirmo NBA čempionu gredzenu?",
    options: ["2012", "2014", "2016", "2018"],
    correctAnswer: "2017",
  },
  {
    question:
      "Kurā gadā Kawhi Leonard ieguva savu pirmo NBA čempionu gredzenu ar Toronto Raptors?",
    options: ["2017", "2018", "2019", "2020"],
    correctAnswer: "2019",
  },
  {
    question:
      "Cik reizes LeBron James ir bijis NBA finālu Vispārējo vērtējumu MVP?",
    options: ["3 reizes", "5 reizes", "7 reizes", "9 reizes"],
    correctAnswer: "4 reizes",
  },

  {
    question:
      "Cik reizes Kobe Bryant tika iekļauts NBA Vispārējo zvaigžņu spēlē?",
    options: ["12 reizes", "15 reizes", "18 reizes", "20 reizes"],
    correctAnswer: "18 reizes",
  },
  {
    question:
      "Kurā sezonā Michael Jordan ieguva savu rekordlielo vidējo punktu skaitu vienā spēlē?",
    options: ["1986-1987", "1988-1989", "1990-1991", "1992-1993"],
    correctAnswer: "1986-1987",
  },
  {
    question:
      "Cik NBA čempionu gredzenu ir ieguvis Magic Johnson savā karjerā?",
    options: ["3", "5", "7", "9"],
    correctAnswer: "5",
  },
  {
  ...
  {
    question:
      "Kurā gadā Giannis Antetokounmpo ieguva savu pirmo NBA čempionu gredzenu ar Milwaukee Bucks?",
    options: ["2018", "2019", "2020", "2021"],
    correctAnswer: "2021",
  },
  {
    question:
      "Kurā gadā Dwyane Wade ieguva savu pirmo NBA čempionu gredzenu ar Miami Heat?",
    options: ["2004", "2006", "2008", "2010"],
    correctAnswer: "2006",
  },
  {
    question:
      "Kurā gadā Tim Duncan ieguva savu pirmo NBA čempionu gredzenu ar San Antonio Spurs?",
    options: ["1998", "1999", "2002", "2005"],
    correctAnswer: "1999",
  },
  {
    question:
      "Kurā gadā Kareem Abdul-Jabbar ieguva savu pēdējo NBA čempionu gredzenu ar Los Angeles Lakers?",
  ...
  {
    question:
      "Kurā gadā Dirk Nowitzki ieguva savu pirmo NBA čempionu gredzenu ar Dallas Mavericks?",
    options: ["2005", "2007", "2009", "2011"],
    correctAnswer: "2011",
  },
  {
    question:
      "Kurā gadā Magic Johnson ieguva savu pirmo NBA čempionu gredzenu ar Los Angeles Lakers?",
    options: ["1979", "1982", "1984", "1987"],
    correctAnswer: "1980",
  },
  {
    question:
      "Kurā gadā Larry Bird ieguva savu pirmo NBA čempionu gredzenu ar Boston Celtics?",
    options: ["1979", "1981", "1983", "1986"],
    correctAnswer: "1981",
  },
  {
    question:
      "Kurā gadā Hakeem Olajuwon ieguva savu pirmo NBA čempionu gredzenu ar Houston Rockets?",
  ...
  {
    question:
      "Kurā sezonā bija visdārgākā vidējā cena par NBA regulārās sezonas spēļu biļetēm?",
  ...
  {
    question: "Kurā pilsētā notika pirmais NBA Slam Dunk konkurss?",
    options: ["Chicago", "Los Angeles", "New York", "Dallas"],
    correctAnswer: "Denver",
  },
  {
    question:
      "Kurš spēlētājs ir uzvarējis visvairāk reižu NBA Slam Dunk konkursā?",
    options: [
      "Vince Carter",
      "Michael Jordan",
      "Dominique Wilkins",
    ...
    correctAnswer: "Nate Robinson",
  },
  {
    question:
      "Kurš spēlētājs izpildīja slavenu 'Free Throw Line Dunk' NBA Slam Dunk konkursā?",
  ...
  },
  {
    ...
    correctAnswer: "Derrick Jones Jr.",
  },
  {
  ...
  },
  {
    ...
    correctAnswer: "Donovan Mitchell",
  },
  {
    ...
    correctAnswer: "Glenn Robinson III",
  },
  {
  ...
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Minnesota Timberwolves", "Detroit Pistons", "Washington Wizards", "Houston Rockets"],
    correctAnswer: "Minnesota Timberwolves",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Orlando Magic", "Portland Trail Blazers", "Washington Wizards", "Houston Rockets"],
    correctAnswer: "Orlando Magic",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Phoenix Suns", "Portland Trail Blazers", "Detroit Pistons", "Dallas Mavericks"],
    correctAnswer: "Phoenix Suns",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Utah Jazz", "Portland Trail Blazers", "Washington Wizards", "Dallas Mavericks"],
    correctAnswer: "Utah Jazz",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Memphis Grizzlies", "Detroit Pistons", "Washington Wizards", "Houston Rockets"],
    correctAnswer: "Memphis Grizzlies",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["LA Clippers", "Portland Trail Blazers", "Dallas Mavericks", "Houston Rockets"],
    correctAnswer: "LA Clippers",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Indiana Pacers", "Detroit Pistons", "Washington Wizards", "Houston Rockets"],
    correctAnswer: "Indiana Pacers",
  },
  {
    question: "Kura no šim komandām nekad nav uzvarējusi NBA čempiontitulu?",
    options: ["Charlotte Hornets", "Portland Trail Blazers", "Washington Wizards", "Houston Rockets"],
    correctAnswer: "Charlotte Hornets",
  },
  {
  ...
  },
  {
    ...
    options: ["Andrew Wiggins", "Tim Duncan", "Kevin Garnet", "Glen Davis"],
    correctAnswer: "Glen Davis",
  },
  {
  question: "Kurš spēlētājs bija NBA Most Improved Player sezonā 2016-2017?",
  options: ["Giannis Antetokounmpo", "Rudy Gobert", "Kemba Walker", "Nikola Jokic"],
  correctAnswer: "Giannis Antetokounmpo",
},
{
  question: "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2015-2016?",
  options: ["C.J. McCollum", "Kawhi Leonard", "Isaiah Thomas", "Draymond Green"],
  correctAnswer: "C.J. McCollum",
},
{
  question: "Kurš spēlētājs bija NBA Most Improved Player sezonā 2014-2015?",
  options: ["Jimmy Butler", "Klay Thompson", "Draymond Green", "Kyrie Irving"],
  correctAnswer: "Jimmy Butler",
},
{
  question:
    "Kurš spēlētājs saņēma NBA Defensive Player of the Year balvu sezonā 2012-2013?",
  options: ["Marc Gasol", "Joakim Noah", "Serge Ibaka", "Roy Hibbert"],
  correctAnswer: "Marc Gasol",
},
{
  ...
  correctAnswer: "Tyson Chandler",
},
{
  question:
    "Kurš spēlētājs saņēma NBA Defensive Player of the Year balvu sezonā 2009-2010?",
...
},
{
  question:
    "Kurš treneris saņēma NBA Coach of the Year balvu sezonā 2013-2014?",
  options: ["Gregg Popovich", "Doc Rivers", "Tom Thibodeau", "Frank Vogel"],
  correctAnswer: "Gregg Popovich",
},
{
...
{
  question:
    "Kurš spēlētājs saņēma NBA Most Improved Player balvu sezonā 2002-2003?",
  options: ["Gilbert Arenas", "Jermaine O'Neal", "Tracy McGrady", "Shawn Marion"],
  correctAnswer: "Gilbert Arenas",
},
{
  question:
    "Kurš spēlētājs bija NBA Sixth Man of the Year sezonā 1999-2000?",
  options: ["Rodney Rogers", "Antoine Walker", "Steve Smith", "Jamal Mashburn"],
  correctAnswer: "Rodney Rogers",
},
{
  question:
    "Kurš spēlētājs saņēma NBA Defensive Player of the Year balvu sezonā 1997-1998?",
...
},
{
  ...
  correctAnswer: "Detroit Pistons (2004)",
},
{
...
},
{
  ...
  correctAnswer: "Denver Nuggets (2012-13)",
},
{
...
{
  question: "Kurš spēlētājs ieguva MVP, nesasniedzot pat 50 uzvaras sezonā?",
  options: ["Russell Westbrook", "Moses Malone", "Kareem Abdul-Jabbar", "Nikola Jokić"],
  correctAnswer: ["Russell Westbrook", "Moses Malone", "Kareem Abdul-Jabbar"],
},
{
...
},
{
  ...
  correctAnswer: "Houston Rockets (1995)",
},
{
...
},
{
  ...
  correctAnswer: "Damon Stoudamire",
},
{
...
},
{
  ...
  correctAnswer: "Chauncey Billups",
},
{
